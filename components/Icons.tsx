...
export const ChefHat: React.FC<{ className?: string }> = ({ className }) => (
  <svg
...
export const HeartPulse: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    width="24"
    ...
    strokeLinejoin="round"
  >
    <path d="M22 12h-2.5l-3.5-7-5 13-2.5-5.5H2" />
    <path d="M11.5 14.5a2.5 2.5 0 0 1-5 0 2.5 2.5 0 0 1 5 0z" />
    <path d="M22 12a2.5 2.5 0 0 1-5 0 2.5 2.5 0 0 1 5 0z" />
  </svg>
);
